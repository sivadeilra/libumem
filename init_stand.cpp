...
void umem_type_init(caddr_t base, size_t len, size_t pgsize) {
  pagesize = pgsize;
...
int umem_get_max_ncpus(void) { return (1); }

int umem_add(caddr_t base, size_t len) { return (vmem_stand_add(base, len)); }
